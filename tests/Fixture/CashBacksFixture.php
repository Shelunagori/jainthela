...
class CashBacksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cash_back_no' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'claim' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => 'no', 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'cash_back_no' => 'Lorem ipsum dolor sit amet',
            'customer_id' => 1,
            'amount' => 1.5,
            'claim' => 'Lorem ipsum dolor ',
            'created_on' => 1499074968
        ],
    ];
}
