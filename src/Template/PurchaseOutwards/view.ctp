...
<div style="border:solid 1px #c7c7c7;background-color: #FFF;padding: 10px;margin: auto;width: 55%;font-size: 12px;" class="maindiv">	
	<table width="100%" class="divHeader">
		...
		<tr>
			<td colspan="3"><div style="font-size: 18px" align="center">Purchase Outward Voucher</div>
			...
			<td width="50%" valign="top" align="left">
				<table>
					...
					<tr>
						<td>Vendor</td>
						<td width="20" align="center">:</td>
						<td ><?= h($purchaseOutward->vendor->name)  ?></td>
	...
	<table width="100%" class="table" style="font-size:12px" align="center">
		...
		<?php $i=0;
		foreach ($purchaseOutward->purchase_outward_details as $data){ ?>
			<tr>
				<td ><?=h(++$i)?></td>
