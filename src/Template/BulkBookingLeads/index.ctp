					...
					<tr>
						...
						<?php if($status=='pending'){ ?>
							<td class="actions">
								...
								<?php echo  $this->Form->postLink('<i class="fa fa-trash"></i>', ['action' => 'delete', $bulkBookingLead->id], ['escape'=>false,'class'=>'btn btn-xs btn-danger','confirm' => __('Are you sure you want to Close # {0}?', $bulkBookingLead->id)]); ?>
							</td>
						<?php } ?>
					</tr>
					<?php endforeach; ?>
